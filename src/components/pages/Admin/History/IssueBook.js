...
import { postIssueBook } from "../../../../redux/History/BorrowBookDataSlice";
...
const IssueBook = () => {
  ...
  const {
    ...
    loading: bookLoading,
    error: bookError,
  } = useSelector((state) => state.getAllBooks);
  const {
    getAllPatronData,
    loading: patronLoading,
    error: patronError,
  } = useSelector((state) => state.getAllPatrons);
